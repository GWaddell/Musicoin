...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Musicoin " + FormatFullVersion();
...
//    {"musicointools.com", "dnsseed.musicointools.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
//    {"musicointools.com", "testnet-seed.musicointools.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Musicoin is probably already running."), addrBind.ToString().c_str());
        else
